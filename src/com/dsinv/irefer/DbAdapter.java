...
//			}
    ...
    public Cursor fetchLimited(int tableId) throws RuntimeException {
        ...
        if(tableId == 0) {
            return dbr.query(true,tname[tableId], tcols[tableId], null, null, tcols[tableId][1], null, "last_name", "50");
        } else if(tableId == 6) {
            return dbr.query(true,tname[tableId], tcols[tableId], null, null, tcols[tableId][1], null, "u_rank, grade, first_name", "50");
        } else if(tableId >= 8) {
            return dbr.query(true,tname[tableId], tcols[tableId], null, null, tcols[tableId][1], null, null, "50");
        } else {
            return dbr.query(true,tname[tableId], tcols[tableId], null, null, tcols[tableId][1], null, "name", "50");
        }
    }
    //returns CURSOR or NULL
